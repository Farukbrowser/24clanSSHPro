...
Isadmin=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/Profile/main/Profile/permission/ip | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/Profile/main/Profile/permission/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
sleep 2
wget -q -O /root/install_up.sh "https://raw.githubusercontent.com/Farukbrowser/24clanSSHPro/main/menu/install-up.sh" && chmod +x /root/install_up.sh
sleep 2
./install_up.sh
sleep 5
rm /root/install_up.sh
rm /opt/.ver
version_up=$( curl -sS https://raw.githubusercontent.com/Farukbrowser/Profile/main/Profile/permission/versi )
...
serverV=$( curl -sS https://raw.githubusercontent.com/Farukbrowser/24clanSSHPro/main/menu/versi )
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}${WH}• Thanks For Using My Script •${NC}  $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
if [ "$Isadmin" = "ON" ]; then
...
echo -e "$COLOR1 ${NC}                ${WH}• FARUK BROWSER •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1 ${NC}             ${WH}• 24clanSSHPro SCRIPT •${NC}                 $COLOR1 $NC"
echo -e "$COLOR1 ${NC}                  ${WH}• PREMIUM •${NC}                    $COLOR1 $NC"
echo -e "$COLOR1 ${NC}             ${WH}• WA : +2348084124966 •${NC}             $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
